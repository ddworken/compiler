...
lambda_19:
  ...
  mov RAX, R11
  cmp RAX, R12
  jne near _cmp_fail_36
  mov RAX, 0xffffffffffffffff
  jmp near _cmp_done_36
_cmp_fail_36:
...
if_false_21:
  mov RAX, [RBP+24]
  mov [RBP-16], RAX ; [RBP-16] holds the variable tmp_65
  mov RAX, [RBP+16]
  mov R11, RAX
  ...
  mov [RBP-24], RAX ; [RBP-24] holds the variable binop_69
  mov RAX, [RBP+32]
...
memcheck_ok_13:
  ...
  add RAX, 0x1
  add R15, 32
  mov [RBP-56], RAX ; [RBP-56] holds the variable a_87
  mov RAX, [RBP-48]
  ;; Assert that RAX has the tag 5 (aka: 'closure')
  mov R11, RAX
  shl R11, 61
