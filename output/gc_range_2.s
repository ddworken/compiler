...
lambda_46:
  ...
  mov RAX, R11
  cmp RAX, R12
  jne near _cmp_fail_63
  mov RAX, 0xffffffffffffffff
  jmp near _cmp_done_63
_cmp_fail_63:
...
lambda_11:
  ...
  mov RAX, R11
  cmp RAX, R12
  jne near _cmp_fail_43
  mov RAX, 0xffffffffffffffff
  jmp near _cmp_done_43
_cmp_fail_43:
  mov RAX, 0x7fffffffffffffff
_cmp_done_43:
...
if_false_13:
  ...
  sub RAX, R12
  jo near _global_overflow_abort
  mov [RBP-24], RAX ; [RBP-24] holds the variable binop_110
  mov RAX, [RBP+24]
  ;; Assert that RAX has the tag 5 (aka: 'closure')
  mov R11, RAX
  shl R11, 61
...
memcheck_ok_23:
  ...
  add RAX, 0x1
  add R15, 32
  mov [RBP-40], RAX ; [RBP-40] holds the variable x_105
  mov RAX, [RBP-8]
  ;; Assert that RAX has the tag 5 (aka: 'closure')
  mov R11, RAX
  shl R11, 61
