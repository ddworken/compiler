...
memcheck_ok_61:
  ...
  mov [RBP-128], RAX ; [RBP-128] holds the variable binop_109
  mov RAX, [RBP-128]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-136], RAX ; [RBP-136] holds the variable binop_108
  mov RAX, [RBP-136]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-144], RAX ; [RBP-144] holds the variable binop_107
  mov RAX, [RBP-144]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-152], RAX ; [RBP-152] holds the variable binop_106
  mov RAX, [RBP-152]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-160], RAX ; [RBP-160] holds the variable binop_105
  mov RAX, [RBP-160]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-168], RAX ; [RBP-168] holds the variable binop_104
  mov RAX, [RBP-168]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-176], RAX ; [RBP-176] holds the variable binop_103
  mov RAX, [RBP-176]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
  ...
  add RAX, R12
  jo near _global_overflow_abort
  mov [RBP-184], RAX ; [RBP-184] holds the variable binop_102
  mov RAX, [RBP-184]
  mov R11, RAX
  ;; Assert that R11 holds a number
  test QWORD R11, 0x1
